      ...
      >
        ...
        <View style={styles.infoSection}>
          <View style={styles.textContainer}>
            ...
            <Text style={styles.infoText}>
              ...
              의미합니다. 전세가율이 높은 경우 전세사기에 노출될 가능성이 크니
              전세가율을 확인해보세요!
            </Text>
          </View>
        </View>
        ...
        <View style={styles.infoSection}>
          <View style={styles.textContainer}>
            ...
            <Text style={styles.infoText}>
              무허가, 불법 건축물로 등록 및 주택용도 여부 확인을 꼭 해야 합니다.
              해당 건축물이 불법 건축물로 판명된 경우 이에 따라 계약 명칭을 받을
              수 없고 &quot;법적 분쟁&quot;으로 이어질 수 있으니 확인해보세요!
            </Text>
          </View>
        </View>
        ...
        <View style={styles.infoSection}>
          <View style={styles.textContainer}>
            ...
            <Text style={styles.infoText}>
              임차주택의 근저당, 과다한 대출 여부를 확인할 필요가 있어요. 해당
              부동산의 소유권자가 대출금을 갚지 못해서 해당 부동산이 경매로
              넘어가게 되면 은행의 근저당권이 ‘ 전세금을 우선 변제 ‘ 하는 경우가
              있기 때문에 임차인은 ‘ 보험금을 잃을 위험 ‘ 이 있습니다. 또한 ‘
              전세권 우선 순위’를 확인하여 우선 변제 순위를 확인해봐야해요. 만약
              ‘선순위 근저당권’ + ‘채권’ &gt; ‘주택 매매 가격’ 이라면 주택이
              팔려도 근저당 및 채권을 돌려줄 수 없으니 주의해야해요!{' '}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.infoSection}>
          <View style={styles.textContainer}>
            ...
            <Text style={styles.infoText}>
              ...
              다수 발생하고 있습니다. 개업한 공인중개사가 자격 등록 후 정상영업
              중인지 확인 하며 계약 당사자가 등기부등본 ,건축물대장 상 소유자와
              동일한지 신분 확인을 해보세요!{' '}
            </Text>
          </View>
        </View>
